package com.assignment.userservice.mail;
...
public class MailMethod {
	...
	public static void sendMail(String email, String message1 , String subject , String content) {
		...
		try {
			...
			InternetAddress sender = new InternetAddress("naveen.navnish@gmail.com", "Book Spot");
			...
			transport.connect("smtp.gmail.com", 587, "naveen.navnish@gmail.com" , "11245Navnish");
